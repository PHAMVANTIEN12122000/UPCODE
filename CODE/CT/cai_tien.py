...
score_svm = pickle.load(open('E:\DATN_PHAMVANTIEN\CODE\CT\score_svm.pkl','rb'))
print('==> Tỷ Lệ chính xác cao nhất của lần train trước đó được lưu là :',round(score_svm * 100,3),'%' )

if(min1 > score_svm):
    score_svm = min1
    pickle.dump(score_svm, open('E:\DATN_PHAMVANTIEN\CODE\CT\score_svm.pkl','wb'))
    pickle.dump(very_good_svm, open('E:\DATN_PHAMVANTIEN\CODE\CT\model.pkl','wb'))


model = pickle.load(open('E:\DATN_PHAMVANTIEN\CODE\CT\model.pkl','rb'))
